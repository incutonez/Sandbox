export default {
	root: ({ props, context, parent }) => ({
		class: [
			...
			{
				"text-gray-500 hover:bg-gray-300/20": props.outlined && props.severity === null && !props.plain,
			},
			...
			"focus:outline-none focus:outline-offset-0 focus:ring-2 focus:ring-offset-sky-500 focus:ring-sky-200",
			{
			...
			// Plain
			{
				"hover:bg-sky-200 hover:ring-sky-200": props.plain && !props.outlined && !props.text,
			},
			...
			{
				"focus:ring-sky-300 dark:focus:ring-sky-300": props.severity === null,
			},
			// Text & Outlined Button
			{
