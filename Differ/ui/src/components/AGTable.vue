...
suppress-row-hover-highlight suppress-cell-selection :tree-data="!serverPaging" :pagination="serverPaging" :pagination-page-size="20" @grid-ready="onGridReady" @pagination-changed="onPaginationChanged"
    />
  </article>
</template>
...
import { ChangeStatus, DiffGet200ResponseInner } from "@incutonez/differ-shared";
import type { ColDef, ColSpanParams, GridApi, GridReadyEvent, ICellRendererParams, IRowNode, IServerSideGetRowsParams } from "ag-grid-community";
...
import type { IPropsAGTable, ITreeRow, ITreeRowMeta } from "@/types/components";
