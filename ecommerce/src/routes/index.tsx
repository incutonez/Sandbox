...
import { useLoadProductsFeatured } from "@/hooks/products.ts";
...
export function RouteComponent() {
	const { data = [], isFetching } = useLoadProductsFeatured();
	return isFetching ? <LoadingMask /> : <ProductFeatured products={data} />;
}

export function ProductFeatured({ products }: IProductFeatured) {
